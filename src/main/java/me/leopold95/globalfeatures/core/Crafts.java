package me.leopold95.globalfeatures.core;

import me.leopold95.globalfeatures.GlobalFeatures;
import me.leopold95.globalfeatures.utils.Utils;
...
public class Crafts {
	private GlobalFeatures plugin;
	private List<Material> planks;

	public Crafts(GlobalFeatures plugin){
		this.plugin = plugin;
